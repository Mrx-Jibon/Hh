...
author = 'MRX JIBON'
WHATSAPP = '+880186544636'
faceb0ok = 'Md Jibon Islam'
notice = 'if you want to buy a good prem sc wa aja'
version = 'next blade v.1.4'

logo1 =                                          ("""   

      s.  s.  .s5SSSs.  .s5SSSs.  .s    s. 
      SS. SS.       SS.       SS.       SS. 
      S%S S%S sS    S%S sS    S%S sSs.  S%S 
      S%S S%S SS    S%S SS    S%S SS`S. S%S 
      S%S S%S SS .sSSS  SS    S%S SS `S.S%S 
      S%S S%S SS    S%S SS    S%S SS  `sS%S
      `:; `:; SS    `:; SS    `:; SS    `:;
.,;   ;,. ;,. SS    ;,. SS    ;,. SS    ;,.
`:;;;;;:' ;:' `:;;;;;:' `:;;;;;:' :;    ;:'

